...
MTP speculative decoding proposes 5 draft tokens, then verifies them in one batched forward pass. Qwen3.5 has 48 GDN (Gated DeltaNet) layers with non-invertible recurrent state:
